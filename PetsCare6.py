...
def ABRIR_VENTANA2():
    ...
    tk.Button(ventana2, text="REGISTRAR", font=("Arial",13,"bold"),bg="#A9C1CC",command=REGISTRO).pack(pady=10)
    tk.Button(ventana2, text="REGRESAR AL MENÚ", font=("Arial",13,"bold"),bg="#A9C1CC",command=ventana2.destroy).pack()

def ABRIR_VENTANA3():
    global ventana3,combo_imc
    ...
    tk.Label(ventana3, text="Elige una mascota.", font=("Arial",13,"bold"),bg="#D2DFE5").pack()

    combo_imc=ttk.Combobox(ventana3)
    combo_imc["values"]=list(mascotas.keys())
    combo_imc.pack(pady=10)

    tk.Button(ventana3, text="CALCULAR IMC", font=("Arial",13,"bold"),bg="#A9C1CC",command=IMC).pack(pady=5)
    tk.Button(ventana3, text="REGRESAR AL MENÚ", font=("Arial",13,"bold"),bg="#A9C1CC",command=ventana3.destroy).pack()

def ABRIR_VENTANA4():
    global ventana4,combo_edad
    ...
    tk.Label(ventana4, text="Elige una mascota.", font=("Arial",13,"bold"),bg="#D2DFE5").pack()

    combo_edad=ttk.Combobox(ventana4)
    combo_edad["values"]=list(mascotas.keys())
    combo_edad.pack(pady=10)

    tk.Button(ventana4, text="TRANSFORMAR EDAD", font=("Arial",13,"bold"),bg="#A9C1CC",command=EDAD).pack(pady=5)
...
def DATOS():
    ...
    mascotas[nombre]=MASCOTA(nombre,especie,raza,edad,peso,sexo,altura)
...
def REGISTRO():
    ...
    frame_form=tk.Frame(ventana2, bg="#D2DFE5")
    frame_form.pack(pady=20)

    tk.Label(frame_form, text="Ingrese los datos de su mascota:",font=("Arial",13,"bold"),bg="#D2DFE5").grid(row=1, column=0, padx=10,pady=5)
    tk.Label(frame_form, text="Nombre:",font=("Arial",13),bg="#D2DFE5").grid(row=2, column=0, padx=10,pady=5)
    entry_nombre=tk.Entry(frame_form)
    entry_nombre.grid(row=2, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Edad(años):",font=("Arial",13),bg="#D2DFE5").grid(row=3, column=0, padx=10,pady=5)
    entry_edad=tk.Entry(frame_form)
    entry_edad.grid(row=3, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Peso(kg):",font=("Arial",13),bg="#D2DFE5").grid(row=4, column=0, padx=10,pady=5)
    entry_peso=tk.Entry(frame_form)
    entry_peso.grid(row=4, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Especie(perro/gato):",font=("Arial",13),bg="#D2DFE5").grid(row=5, column=0, padx=10,pady=5)
    entry_especie=tk.Entry(frame_form)
    entry_especie.grid(row=5, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Sexo(macho/hembra):",font=("Arial",13),bg="#D2DFE5").grid(row=6, column=0, padx=10,pady=5)
    entry_sexo=tk.Entry(frame_form)
    entry_sexo.grid(row=6, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Raza(pequeña/mediana/grande):",font=("Arial",13),bg="#D2DFE5").grid(row=7, column=0, padx=10,pady=5)
    tk.Button(frame_form, text="Peso de cada raza",font=("Arial",11,"bold"),bg="#A9C1CC",command=RAZA).grid(row=9, column=1, padx=10,pady=5)
    entry_raza=tk.Entry(frame_form)
    entry_raza.grid(row=7, column=1, padx=10,pady=5)
    tk.Label(frame_form, text="Ingresa altura hasta los hombros(cm):",font=("Arial",13),bg="#D2DFE5").grid(row=8, column=0, padx=10,pady=5)
    tk.Button(frame_form, text="¿Cómo puedo medir la altura hasta los hombros?",font=("Arial",11,"bold"),bg="#A9C1CC",command=A_HOMBROS).grid(row=9, column=0, padx=10,pady=5)
    entry_altura=tk.Entry(frame_form)
    entry_altura.grid(row=8, column=1, padx=10,pady=5)
